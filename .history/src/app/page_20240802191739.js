          ...
          <div className="bg-slate-800 p-4 rounded-lg">
            ...
            <ul>
              {items.map((item, id) => (
                ...
                >
                  <div className="grid-cols-6 p-4 w-full flex justify-between">
                    <span className="col-span-1 capitalize">{item.name}</span>
                    <span className="col-span-1 capitalize>{item.quantity}</span>
