...
export default function Home() {
  ...
  const handleCapture = (file) => {
    console.log("Handle Capture called with file:", file);
        ...
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm ">
          ...
          <div className="bg-slate-800 p-4 rounded-lg">
            <form className="grid grid-cols-6 items-center text-black">
                  ...
                  <div className="fixed top-0 left-0 w-full h-full bg-black flex flex-col items-center justify-center z-50">
                    <div className="relative">
                      <Camera
                        ...
                        onTakePhoto={(file) => {
                          console.log(
                            "Photo taken callback triggered with file:",
                            file
                          );
                          handleCapture(file);
                        }}
              ...
              <DatePicker
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    className="col-span-2 p-3 border mx-4"
              ...
              <button
                onClick={addItem}
                className="col-span-2 p-3 border mx-4 bg-blue-500 text-white rounded"
              >
                Add Item
              </button>
            </form>
            ...
            <form className="mt-6">
              ...
              <button
                onClick={updateItem}
                className="p-3 border mx-4 bg-blue-500 text-white rounded"
              >
                Update Item
              </button>
            </form>
                ...
                {filteredItems.map((item) => (
                  <li key={item.id} className="flex items-center mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p>Date: {dayjs(item.date).format("MM/DD/YYYY")}</p>
