  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <main className="flex min-h-screen flex-col items-center justify-between p-24 ">
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm scroll-smooth">
          <h1 className="text-1xl p-4 text-center">Available Items</h1>
          <h1 className="text-1xl p-4 text-center">
