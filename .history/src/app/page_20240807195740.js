...
import { v4 } from "uuid";
import { classifyImage } from "/Users/rakeshpuppala/Desktop/Pantry_Tracker/src/app/classify.js";
...
export default function Home() {
  ...
  const handleCapture = async () => {
    if (camera.current) {
      ...
      const imageBlob = dataURItoBlob(photoData);
      ...
      setImageFileName(`captured_image_${Date.now()}.jpg`);
